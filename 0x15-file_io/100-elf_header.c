 ...
 *
 * @param e_ident A pointer to an array containing the ELF data type.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 *
 * @param e_ident A pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 *
 * @param e_ident A pointer to an array containing the ELF OS/ABI.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 *
 * @param e_ident A pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * Return: 0 on success.
 *
 * Description: Exits with code 98 if the file is not an ELF File or if the function fails.
 */
